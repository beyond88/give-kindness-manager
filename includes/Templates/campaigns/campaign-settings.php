<div class="give-donor-dashboard-tab-content" id="give_kindness_manager-campaign-settings" data-tab-content="give_kindness_manager-campaign-settings">
   ...
   <button class="give-donor-dashboard-button give_kindness_manager-update-campaign give-donor-dashboard-button--primary" id="give_kindness_manager-update-campaign"  data-campaign-id="">
