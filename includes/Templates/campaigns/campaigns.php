...
<div class="give-donor-dashboard-tab-content" id="give_kindness_manager-campaigns" data-tab-content="give_kindness_manager-campaigns">
    ...
    <div class="give-donor-dashboard-table give-kindness-campaigns-container give-kindness-campaign-list-item" style="opacity: 0.5">
        ...
        <div class="give-donor-dashboard-table__rows give-kindness-items-container">
            ...
            <?php 
                ...
                // $donations = give_get_form_earnings_stats( $campaign->ID );
                $donations = new \Give_Payments_Query(
                    array(
                        'give_forms' => array( $campaign->ID ),
                        'number'     => - 1,
                        // 'status'     => array( 'publish' ),
                    )
                );
        
                $donations   = count( $donations->get_payments() );
                //print_r($donations);
            ...
            <div class="give-donor-dashboard-table__row give-kindness-campaigns-item item-visible">
                ...
                <div class="give-donor-dashboard-table__column">
                    <a href="javascript:void(0);" class="view-all-donations" data-form-id="<?php echo $campaign->ID; ?>" data-campaign-name="<?php echo $campaign->post_title; ?>"><?php echo $donations; ?></a>
                </div>
                <div class="give-donor-dashboard-table__column">
                    <?php echo $revenue; ?>
                </div>
    ...
    <div class="give-donor-dashboard-heading give-donor-dashboard-donations-heading give-kindness-donations-area-item">
        <div class="donations-campaign-name give-dashboard-donations-heading-item">
            <span><?php echo __('Campaign Name: ', 'give-kindness-manager'); ?> <span class="display-campaign-name" id="display-campaign-name"></span></span>
        </div>
    ...
    <div class="give-donor-dashboard-table give-kindness-donations-list give-kindness-donations-area-item" id="give-kindness-donations-list">
        <div class="give-donor-dashboard-table__header">
            ...
            <div class="give-donor-dashboard-table__column"><?php echo __('Payment Platform','give-kindness-manager');?></div>
            <div class="give-donor-dashboard-table__column"><?php echo __('Donation Type','give-kindness-manager');?></div>
            <div class="give-donor-dashboard-table__column"><?php echo __('Date','give-kindness-manager');?></div>
        </div>
        <div class="give-donor-dashboard-table__rows give-kindness-donations-list" id="give-kindness-donations-list-area" style="opacity: 0.5">     
        </div>
    </div>    
</div>
