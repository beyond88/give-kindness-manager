   ...
   <div class="give-donor-dashboard__auth">
      <div class="give-donor-dashboard__auth-modal">
         <div class="give-donor-dashboard__auth-modal-frame">
            <div class="give-donor-dashboard__auth-modal-heading"><?php echo __('Sign in to see your dashboard', 'give-kindness-manager'); ?></div>
            <div class="give-donor-dashboard__auth-modal-content">
               <form class="give-donor-dashboard__auth-modal-form give-kindness-manager-login-part" id="give-kindness-manager-login-form" onSubmit="return false;">
                  <div class="give-donor-dashboard-text-control">
                     <div class="give-donor-dashboard-text-control__input">
                        ...
                        <input id="give-kindness-manager-username" type="text" maxlength="60" placeholder="<?php echo __('Username or email', 'give-kindness-manager'); ?>">
                     </div>
                  </div>
                  <div class="give-donor-dashboard-text-control">
                     <div class="give-donor-dashboard-text-control__input">
                        ...
                        <input id="give-kindness-manager-password" type="password" maxlength="60" placeholder="<?php echo __('Password', 'give-kindness-manager'); ?>">
                     </div>
                  </div>
                  <div class="give-donor-dashboard__auth-modal-row">
                     <button class="give-donor-dashboard-button give-donor-dashboard-button--primary" type="submit" id="give-kindness-manager-login-submit">
               ...
               <div class="give-donor-dashboard__auth-modal-instruction give-kindness-manager-login-part">
