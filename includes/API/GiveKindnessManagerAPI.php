...
namespace GivekindnessManager\API;
use WP_REST_Request;
use WP_REST_Response;
use WP_REST_Server;
use GivekindnessManager\User; 
use GivekindnessManager\GiveKindnessEmail; 
use GivekindnessManager\Helpers; 
use GivekindnessManager\API\CampaignManagerAPI; 

class GiveKindnessManagerAPI
{

  private $restBase = 'give-kindness-manager/v1';
  private $campaignApi = '';
  ...
  function __construct() {
    ...
    $this->campaignApi = new CampaignManagerAPI();
